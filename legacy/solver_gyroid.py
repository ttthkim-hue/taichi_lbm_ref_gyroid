...
"""
Gyroid 채널용 Taichi LBM 실행 스켈레톤.

역할:
  - OpenLB MN .dat (gyroid_dx02_v3.dat 등)에서 형상 로딩
...
def main() -> None:
    ...
    ap.add_argument("--dat", type=str, required=True, help="OpenLB MN .dat path (e.g. gyroid_dx02_v3.dat)")
    ...
    ap.add_argument("--out", type=str, default="result_taichi_gyroid_dx02.json")
    args = ap.parse_args()
